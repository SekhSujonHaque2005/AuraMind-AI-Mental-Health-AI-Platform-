...
import { MessageSquare, BookUser, Users, Sparkles, ShieldCheck, FileQuestion, Music, Home, Handshake } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/counselor-connect', label: 'Counselor Connect', icon: Handshake },
