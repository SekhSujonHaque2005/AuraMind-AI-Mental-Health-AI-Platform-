...
const GetAuraResponseOutputSchema = z.object({
  ...
  gifUrl: z.string().optional().describe('An optional URL to a relevant, supportive, and gentle GIF from a public source like Giphy.'),
});
...
5.  **Include a GIF (Optional):** If you can find a highly relevant, supportive, and gentle GIF from a public source like Giphy that strongly matches the tone of your response, you can add the direct media URL for the GIF to the 'gifUrl' field. This is optional.
