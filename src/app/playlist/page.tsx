...
export const staticTracks: Track[] = [
  // Ambient (10 tracks)
  {
    ...
    reasonToListen: <p>Ease into your day with this calming ambient track. Perfect for meditation, yoga, or simply enjoying a quiet cup of coffee as the sun rises. Let the gentle tones wash over you, clearing your mind for the day ahead.</p>,
  },
  {
    id: 12,
    ...
    reasonToListen: <p>Drift away into the cosmos with this ethereal ambient track. The deep, resonant tones and subtle electronic textures create a feeling of weightlessness and serenity, ideal for deep meditation or unwinding.</p>,
  },
  {
    id: 13,
    title: 'Dreamy Vistas',
  ...
  // Nature (10 tracks)
  {
    ...
    reasonToListen: <p>Immerse yourself in the serene soundscape of a forest. The gentle rustling of leaves, distant bird calls, and the soft whisper of the wind create a perfect atmosphere for focus and relaxation.</p>,
  },
  {
    id: 11,
  ...
  // Water Sounds (10 tracks)
  {
    ...
    reasonToListen: <p>Let the continuous, gentle sound of a flowing stream wash away your stress. This track is ideal for creating a peaceful environment for studying, working, or unwinding after a long day.</p>,
  },
  {
    id: 7,
    title: 'Ocean Waves',
  ...
  // Instrumental (10 tracks)
  {
    ...
    reasonToListen: <p>A beautiful and simple piano melody to help you find your center. The minimalist composition provides a backdrop of calm without being distracting, encouraging a state of mindfulness.</p>,
  },
  {
    id: 14,
  ...
  // Binaural (10 tracks)
  {
    ...
    reasonToListen: <p>Utilize the power of binaural beats to enhance your focus and concentration. This track is designed to help you enter a flow state, making it perfect for complex tasks and creative work. Use headphones for the best effect.</p>,
  },
  {
    id: 15,
  ...
  // Soundscape (10 tracks)
  {
    ...
    reasonToListen: <p>The comforting sound of rain tapping on a window pane, mixed with the subtle, warm ambiance of a quiet coffee shop. Ideal for reading, studying, or simply relaxing on a cozy afternoon.</p>,
  },
  {
    id: 10,
  ...
  // Lofi (10 tracks)
  {
    ...
    reasonToListen: <p>A smooth, instrumental lofi hip hop track to help you study, work, or relax. The chill beats and simple melodies create a productive and stress-free atmosphere.</p>,
  },
  {
    id: 16,
  ...
  // Meditation (10 tracks)
  {
    ...
    reasonToListen: <p>The resonant, healing sounds of Tibetan singing bowls. This track is designed for deep meditation, helping to balance your chakras and promote a sense of inner peace and clarity.</p>,
  },
  {
    id: 17,
    ...
    reasonToListen: <p>Follow a calm voice as it guides you through a simple but powerful breathing exercise. Perfect for beginners or anyone looking to anchor themselves in the present moment.</p>,
  },
  { id: 901, title: '5-Minute Mindful Break', artist: 'The Mindfulness Guide', releaseDate: '2023-03-14', category: 'Meditation', duration: '5:00', url: 'https://firebasestorage.googleapis.com/v0/b/auramind-14qmq.firebasestorage.app/o/5-Minute%20Mindful%20Break.mp3?alt=media&token=52dcf3a5-3b65-4d82-bda9-6a897dd2dbc2', description: 'A short break to reset your day.', src: 'https://www.firstforwomen.com/wp-content/uploads/sites/2/2020/12/shutterstock_640975615.jpg?quality=86&strip=all', reasonToListen: <p>A quick, 5-minute guided meditation to help you reset and refocus during a busy day.</p> },
