...
const staticTracks: Track[] = [
  ...
  { id: 901, title: '5-Minute Mindful Break', category: 'Meditation', duration: '5:00', url: 'https://firebasestorage.googleapis.com/v0/b/auramind-14qmq.firebasestorage.app/o/SoundHelix-Song-9.mp3?alt=media&token=d1d8a39a-7c9e-4e4b-9723-5e865f12e841', description: 'A short break to reset your day.', src: 'https://www.firstforwomen.com/wp-content/uploads/sites/2/2020/12/shutterstock_640975615.jpg?quality=86&strip=all', content: () => <p>A quick, 5-minute guided meditation to help you reset and refocus during a busy day.</p> },
  ...
  { id: 905, title: 'Zen Garden Ambience', category: 'Meditation', duration: '20:00', url: 'https://firebasestorage.googleapis.com/v0/b/auramind-14qmq.firebasestorage.app/o/SoundHelix-Song-9.mp3?alt=media&token=d1d8a39a-7c9e-4e4b-9723-5e865f12e841', description: 'Sounds of a peaceful Zen garden.', src: 'https://plus.unsplash.com/premium_photo-1661954483883-edd65eac3577?fm=jpg&q=60&w=3000&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8emVuJTIwZ2FyZGVufGVufDB8fDB8fHww', content: () => <p>An unguided soundscape of a Japanese Zen garden for long meditation sessions.</p> },
