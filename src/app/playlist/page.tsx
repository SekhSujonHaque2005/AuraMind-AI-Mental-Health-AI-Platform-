...
const staticTracks: Track[] = [
  ...
  },
  {
   ...
   { id: 101, title: 'Azure Twilight', category: 'Ambient', duration: '5:45', url: 'https://firebasestorage.googleapis.com/v0/b/auramind-14qmq.firebasestorage.app/o/Azure%20Twilight.mp3?alt=media&token=ec4a6b03-749d-4200-a1df-31be5c93519a', description: 'Sounds of the sky at dusk.', src: 'https://images.pexels.com/photos/1486974/pexels-photo-1486974.jpeg?cs=srgb&dl=pexels-souvenirpixels-1486974.jpg&fm=jpg', content: () => <p>As the day ends, let the gentle sounds of twilight bring you peace.</p> },
