...
const staticTracks: Track[] = [
  ...
  { id: 407, title: 'Hang Drum Harmony', category: 'Instrumental', duration: '6:45', url: 'https://firebasestorage.googleapis.com/v0/b/auramind-14qmq.firebasestorage.app/o/SoundHelix-Song-4.mp3?alt=media&token=7d0b8e9a-7a54-4c46-888e-6704b2b1a473', description: 'Hypnotic hang drum rhythms.', src: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS1Pg5ok0EbDAZzSUEA_N-NkqUFFbGQvO2BfE-kIhailrcbEKJHogomUO9gBYQoMG_0Y2U&usqp=CAU', content: () => <p>The hypnotic and meditative tones of a hang drum, ideal for focus.</p> },
